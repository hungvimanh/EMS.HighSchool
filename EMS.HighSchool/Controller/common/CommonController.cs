...
using EMS.HighSchool.Services.MDistrict;
using EMS.HighSchool.Services.MEthnic;
using EMS.HighSchool.Services.MHighSchool;
using EMS.HighSchool.Services.MProvince;
using EMS.HighSchool.Services.MTown;
...
namespace EMS.HighSchool.Controller.common
{
    [AllowAnonymous]
    public class CommonController : ApiController
    {
        ...
        public async Task<List<ProvinceDTO>> ListProvince([FromBody] ProvinceFilterDTO provinceFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = provinceFilterDTO.Code },
                Name = new StringFilter { StartWith = provinceFilterDTO.Name },
        ...
        public async Task<List<DistrictDTO>> ListDistrict([FromBody] DistrictFilterDTO districtFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = districtFilterDTO.Code },
                Name = new StringFilter { StartWith = districtFilterDTO.Name },
        ...
        public async Task<List<TownDTO>> ListTown([FromBody] TownFilterDTO townFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = townFilterDTO.Code },
                Name = new StringFilter { StartWith = townFilterDTO.Name },
        ...
        public async Task<List<HighSchoolDTO>> ListHighSchool([FromBody] HighSchoolFilterDTO highSchoolFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = highSchoolFilterDTO.Code },
                Name = new StringFilter { Contain = highSchoolFilterDTO.Name },
        ...
        public async Task<HighSchoolDTO> GetHighSchool([FromBody] HighSchoolDTO highSchoolDTO)
        {
            ...
            var highSchool = new HighSchoolBO { Id = highSchoolDTO.Id };
        ...
        public async Task<List<EthnicDTO>> ListEthnic([FromBody] EthnicFilterDTO ethnicFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = ethnicFilterDTO.Code },
                Name = new StringFilter { StartWith = ethnicFilterDTO.Name },
