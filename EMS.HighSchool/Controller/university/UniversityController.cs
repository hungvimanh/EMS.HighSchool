...
using EMS.HighSchool.Services.MUniversity;
...
namespace EMS.HighSchool.Controller.university
{
    public class UniversityController : ApiController
    {
        ...
        public async Task<UniversityDTO> Get([FromBody] UniversityFilterDTO universityFilterDTO)
        {
            ...
            University university = new University { Id = universityFilterDTO.Id ?? default };
        ...
        public async Task<List<UniversityDTO>> List([FromBody] UniversityFilterDTO universityFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = universityFilterDTO.Code },
                Name = new StringFilter { Contain = universityFilterDTO.Name },
                Skip = universityFilterDTO.Skip,
                Take = int.MaxValue,
