...
using EMS.HighSchool.Controller.subject_group;
using EMS.HighSchool.Controller.university;
using EMS.HighSchool.Controller.university_majors;

namespace EMS.HighSchool.Controller
{
    public class Root
    {
