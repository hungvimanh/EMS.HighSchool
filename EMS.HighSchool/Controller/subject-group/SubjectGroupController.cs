...
using EMS.HighSchool.Services.MSubjectGroup;
...
namespace EMS.HighSchool.Controller.subject_group
{
    public class SubjectGroupController : ApiController
    {
        ...
        public async Task<List<SubjectGroupDTO>> List([FromBody] SubjectGroupFilterDTO subjectGroupFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = subjectGroupFilterDTO.Code },
                Name = new StringFilter { Contain = subjectGroupFilterDTO.Name },
