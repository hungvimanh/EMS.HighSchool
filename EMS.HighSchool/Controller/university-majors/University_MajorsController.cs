    ...
    public class University_MajorsController : ApiController
    {
        ...
        public async Task<List<University_MajorsDTO>> List([FromBody] University_MajorsFilterDTO university_MajorsFilterDTO)
        {
            University_MajorsFilter university_MajorsFilter = new University_MajorsFilter
            {
                ...
                UniversityCode = new StringFilter { StartWith = university_MajorsFilterDTO.UniversityCode },
                UniversityName = new StringFilter { Contain = university_MajorsFilterDTO.UniversityName },
                MajorsId = university_MajorsFilterDTO.MajorsId,
                MajorsCode = new StringFilter { StartWith = university_MajorsFilterDTO.MajorsCode },
                MajorsName = new StringFilter { Contain = university_MajorsFilterDTO.MajorsName },
