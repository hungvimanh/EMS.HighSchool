...
using EMS.HighSchool.Services.MMajors;
...
namespace EMS.HighSchool.Controller.majors
{
    public class MajorsController : ApiController
    {
        ...
        public async Task<List<MajorsDTO>> List([FromBody] MajorsFilterDTO majorsFilterDTO)
        {
            ...
            {
                Code = new StringFilter { StartWith = majorsFilterDTO.Code },
                Name = new StringFilter { Contain = majorsFilterDTO.Name },
