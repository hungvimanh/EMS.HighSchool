...
namespace EMS.HighSchool.Repositories
{
    ...
    public class University_Majors_SubjectGroupRepository : IUniversity_Majors_SubjectGroupRepository
    {
        ...
        public University_Majors_SubjectGroupRepository(EMSContext _context)
        {
            context = _context;
        }
        ...
        {
            IQueryable<University_Majors_SubjectGroupDAO> university_Majors_SubjectGroupDAOs = context.University_Majors_SubjectGroup;
        ...
        {
            University_Majors_SubjectGroup university_Majors_SubjectGroup = await context.University_Majors_SubjectGroup.Where(u => u.Id == Id).Select(u => new University_Majors_SubjectGroup
            {
                Id = u.Id,
        ...
        {
            await context.University_Majors_SubjectGroup.Where(u => u.Id == Id).DeleteFromQueryAsync();
            return true;
        }
    }
}
