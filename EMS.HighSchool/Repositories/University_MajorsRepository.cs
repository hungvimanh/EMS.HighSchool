...
namespace EMS.HighSchool.Repositories
{
    ...
    public class University_MajorsRepository : IUniversity_MajorsRepository
    {
        ...
        public University_MajorsRepository(EMSContext _context)
        {
            context = _context;
        }
        ...
        {
            IQueryable<University_MajorsDAO> university_MajorsDAOs = context.University_Majors;
        ...
        {
            await context.University_Majors_SubjectGroup.Where(u => u.University_Majors.Id == Id).DeleteFromQueryAsync();
            await context.University_Majors.Where(m => m.Id == Id).DeleteFromQueryAsync();
            return true;
        }

        public async Task<University_Majors> Get(long Id)
        {
            University_Majors University_Majors = await context.University_Majors.Where(m => m.Id == Id).Select(u => new University_Majors
            {
                Id = u.Id,
        ...
        {
            await context.University_Majors.Where(m => m.Id == university_Majors.Id).UpdateFromQueryAsync(u => new University_MajorsDAO
            {
                UniversityId = university_Majors.UniversityId,
                MajorsId = university_Majors.MajorsId,
            });
