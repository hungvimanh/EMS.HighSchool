...
namespace EMS.HighSchool.Services.MStudentService
{
    ...
    public class StudentValidator : IStudentValidator
    {
        ...
        private async Task<bool> ValidateEmail(Student student)
        {
            ...
            if(await UOW.StudentRepository.Count(new StudentFilter { Id = new IdFilter { NotEqual = student.Id }, Email = new StringFilter { Equal = student.Email} }) != 0)
            {
        ...
        private async Task<bool> ValidateIdentify(Student student)
        {
            ...
            {
                Id = new IdFilter { NotEqual = student.Id },
