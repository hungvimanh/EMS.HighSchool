...
namespace EMS.HighSchool.Services.MForm
{
    public interface IFormValidator : IServiceScoped
    {
        ...
        Task<bool> Save(RegisterExam form);
        Task<bool> IsExisted(RegisterExam form);
        Task<bool> Delete(RegisterExam form);
    }
    public class FormValidator : IFormValidator
    {
        ...
        public async Task<bool> IsExisted(RegisterExam form)
        {
